...
Navigate to the directory where you saved `txt2art.py` in your terminal or command prompt and run the script using Python 3:
...
sudo ln -s "$(pwd)/txt2art.py" /usr/local/bin/txt2art
